...
// @ts-ignore
const ScrollPicker: {
    <ItemT extends object>(props: ScrollPickerProps<ItemT> & { ref?: Ref<ScrollPickerHandle> }): React.JSX.Element
    ...
    useEffect(() => {
        // props.selectedIndex retorna 99, enquanto selectedIndex é 100, o que é correto, porém, em algum momento, volta a ser 100
